...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo -cod_idea- no acepta valores nulos"
      }
   }
)
...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo -cod_idea- no acepta valores mas grandes que 0"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo -ano_eje- no acepta valores mas grandes que 0"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
...
expectation_configuration = ExpectationConfiguration(
    ...
    kwargs={
       "column_list": ['ano_eje','cod_idea']
    },
    meta={
       "notes": {
          "format": "markdown",
          "content": "Los campos -ano_eje,cod_idea- no acepta valores duplicados"
       }
    }
 )
...
expectation_configuration = ExpectationConfiguration(
    ...
    meta={
       "notes": {
          "format": "markdown",
          "content": "El campo -cod_idea- acepta valores enteros"
       }
    }
 )
suite.add_expectation(expectation_configuration=expectation_configuration)
