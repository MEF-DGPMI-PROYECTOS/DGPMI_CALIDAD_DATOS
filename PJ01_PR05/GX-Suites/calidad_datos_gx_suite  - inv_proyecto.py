...
expectation_configuration = ExpectationConfiguration(
   ...
   kwargs={
      "column": "id_cartera_inversion",
      "type_": "INTEGER"
   },
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo INTEGER acepta valores enteros"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo ID_CARTERA_INVERSION acepta valores positivos"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
...
expectation_configuration = ExpectationConfiguration(
   expectation_type="expect_column_values_to_be_between",
   kwargs={
      "column": "val_beneficiario_ultimo",
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo VAL_BENEFICIARIO_ULTIMO acepta valores positivos"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
