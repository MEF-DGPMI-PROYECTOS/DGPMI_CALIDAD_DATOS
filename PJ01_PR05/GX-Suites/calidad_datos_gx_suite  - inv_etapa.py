...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo -id_etapa- no acepta valores nulos"
      }
   }
)
...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo -id_etapa- no acepta valores mas grandes que 0"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo -id_etapa- no acepta valores duplicados"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo -id_etapa- acepta valores enteros"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
