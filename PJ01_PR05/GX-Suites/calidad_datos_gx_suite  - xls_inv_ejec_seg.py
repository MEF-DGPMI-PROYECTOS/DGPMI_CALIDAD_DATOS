...
expectation_configuration = ExpectationConfiguration(
   expectation_type="expect_column_values_to_not_be_null",
   kwargs={
      "column": "ultimo_devengado"
   },
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo ULTIMO_DEVENGADO no acepta valores nulos"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo AVAN_EJECUC acepta valores reales"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo AVAN_ESTIM acepta valores reales"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
