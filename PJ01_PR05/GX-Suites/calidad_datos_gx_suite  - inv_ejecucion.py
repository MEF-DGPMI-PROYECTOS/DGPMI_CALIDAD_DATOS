...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo -monto_inversion- no acepta valores nulos"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo -ano_ejec- no acepta valores nulos"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo -id_ejecucion- acepta valores del 2018 hacia adelante"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo FLG_ACTIVO acepta valores enteros menores a 8"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
