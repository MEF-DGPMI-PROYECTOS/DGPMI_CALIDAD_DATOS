...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo -proyecto- no acepta valores nulos"
      }
   }
)
...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo -proyecto- no acepta valores más grandes que 0"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo -proyecto- no acepta valores duplicados"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
...
expectation_configuration = ExpectationConfiguration(
   ...
   meta={
      "notes": {
         "format": "markdown",
         "content": "El campo -proyecto- acepta valores enteros"
      }
   }
)
suite.add_expectation(expectation_configuration=expectation_configuration)
