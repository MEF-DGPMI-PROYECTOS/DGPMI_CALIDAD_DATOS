...
#%%
run_name = "'%Y%m%d-run-" + my_checkpoint_name + '\''
...
validations:
 - batch_request:
     ...
     data_asset_name: table_lnd_xls_inv_ejec_seg
     data_connector_query:
       index: -1

   expectation_suite_name: suite_ds_xls_inv_ejec_seg
"""
print(yaml_config)
...
# In[ ]:
print('Se creó el punto de control: ', my_checkpoint_name )
time.sleep(5)
#%%